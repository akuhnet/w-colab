...
echo Download Windows11
Will be coming soon
echo "Windows 11 Google Colab"
echo Your VNC Address:
curl --silent --show-error http://127.0.0.1:4040/api/tunnels | sed -nE 's/.*public_url":"tcp:..([^"]*).*/\1/p'
echo "Ctrl+C To Copy"
echo "Keep Colab Tab Open, Maximum Time 12h"
./dist/proot -S . qemu-system-x86_64 -vnc :0 -hda w11.qcow2  -smp cores=2  -m 8192M -machine usb=on -device usb-tablet > /dev/null 2>&1
